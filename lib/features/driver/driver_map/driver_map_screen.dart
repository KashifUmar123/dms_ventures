...
class DriverMapScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<DriverMapProvider>(
  ...
  Widget _buildCancelRiderWidget(
    ...
    return Container(
      ...
      child: Column(
        children: [
          if (provider.showPickUpButton && !provider.showCompleteButton) ...[
            SizedBox(
              width: context.width * .8,
              child: Center(
                child: CustomButton(
                  text: "Pickup Rider",
                  onPressed: provider.pickupRider,
          ...
          if (provider.showCompleteButton)
            SizedBox(
              ...
              child: Center(
                child: CustomButton(
                  text: "Complete Ride",
                  onPressed: provider.completeRide,
                  isLoading: provider.isCancelling,
                ),
              ),
            )
